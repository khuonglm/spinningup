...
class SAC(nn.Module):
    ...
    def __init__(
        ...
        self.critic1 = core.Critic(state_size, action_size, hidden_sizes).to(device)
        self.critic2 = core.Critic(state_size, action_size, hidden_sizes).to(device)
        
        assert self.critic1.parameters() != self.critic2.parameters()
        
        self.critic1_target = core.Critic(state_size, action_size, hidden_sizes).to(device)
        self.critic1_target.load_state_dict(self.critic1.state_dict())

        self.critic2_target = core.Critic(state_size, action_size, hidden_sizes).to(device)
...
if __name__ == "__main__":
    ...
    sacd(lambda : gym.make(args.env), actor_critic=SAC,
